  ...
  return (
    <Layout pageTitle="About | ✨Niket Kumar✨">
      <article className="prose max-w-none font-sans" >
        ...
        <p>Hey there, I'm Niket, a third year undergrad pursuing CS. I love to code and build amazing things while approaching social and environmental issues. Apart from coding I love to watch anime and read cybersecurity write-ups (Hacking is fancy :P) Enjoyer of Japanese Culture and everything related to it.
          <br></br>
          <br></br>
